...
(function() {
  $(document).ready(function() {
    return $("#contact").on("ajax:success", function(e, data, status, xhr) {
      $('#contact').modal('hide');
      return $('#notice-box').append("<div class='alert alert-success'>Message Sent!</div>");
    }).on("ajax:error", function(e, data, status, xhr) {
      var errors;
      errors = data.responseJSON.errors;
      return $.each(errors, function(key, value) {
        return $('#modal-body').append("<span class='red'>*" + value + "</span><br>");
      });
    });
  });
